        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="my-5">
                    ...
                    <input type="url" class="form-control" value="{{ $comic->thumb }}" id="thumb" name="thumb"
            ...
            <div class="col-2">
                <div class="my-5">
                    ...
                    <input type="number" min="0.01" step="0.01" class="form-control" value="{{ $comic->price }}"
            ...
            <div class="col-4">
                <div class="my-5">
                    ...
                    <input type="text" class="form-control" value="{{ $comic->series }}" id="series" name="series"
                        placeholder="Serie">
                </div>
            </div>
            <div class="col-4">
                <div class="my-5">
                    ...
                    <input type="text" class="form-control" value="{{ $comic->type }}" id="type" name="type"
            ...
            <div class="col-2">
                <div class="my-5">
                    ...
                    <input type="date" class="form-control" value="{{ $comic->sale_date }}" id="sale_date"
                        name="sale_date" placeholder="Data">
                </div>
            </div>
            <div class="col-12">
